...
class ExtractionStrategyBase(BaseModel):
...
class TextExtraction(ExtractionStrategyBase):
...
class NumberExtraction(ExtractionStrategyBase):
...
class ColorExtraction(ExtractionStrategyBase):
